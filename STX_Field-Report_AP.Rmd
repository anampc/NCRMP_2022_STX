...
* Additionally, changes in benthic cover and carbonate production were monitored at all 15m sites by recording:
  ...
  - **Benthic cover**: 6 landscape mosaics (Salt River Only)
  - **Carbonate budget surveys**: Benthic cover, sponge, urchin and parrotfish surveys completed at 6 transects (Salt River Only)
...
<font size="2"> **Figure 2:** Temperature conditions at four transects in Saint Croix (east, west, north and south) representing a depth gradient (1m, 5m, 15mand 25m). CHANGE THIS: Data were collected from September 2019 to September 2022. **DID ANY NOT LOG THE FULL TIME?)** </font>
