...
```{r front, echo=FALSE, out.width = '75%', fig.cap="New Subsurface Temperature Recorder deployed at XXXXXX label", fig.align='center'}
...
```{r Temp observations}
Cases_Loc_depth<-STR_all %>% count(Transect,
                                  Depth,
                                  sort = F)
...
kable(Cases_Loc_depth,
      ...
      caption = "Number of temperture observations collected by transect and depth")
```
...
```{r makeAmap, echo=FALSE, fig.width = 8.5, fig.height = 4, fig.align='center'}
map<-leaflet(stations, width = '600px') %>% 
  addTiles() %>%
...
<font size="2"> **Figure 2:** Temperature conditions at four transects in St. Croix (east, west, north and south) representing a depth gradient (1m, 5m, 15m and 25m). Data were collected from September 2019 to September 2022. However, STR from north station - 25m stopped recording earlier on February 2022 and STRs from south station - 1m on Nobember 2011. </font>
...
<font size="2">**Figure 4:** Carbonate budgets Salt River Bay in 2019 and 2022 and the processes contributing to calcification and bioerosion.  Carbonate budgets declined in 2022 compared to 2019, mainly due to the reduction in coral production and the increase in urching erosion. </font>
