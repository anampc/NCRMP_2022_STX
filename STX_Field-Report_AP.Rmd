...
```{r front, echo=FALSE, out.width = '75%', fig.cap="Orbicella faveolata colony in St. Croix, USVI", fig.align='center'}
...
map<-leaflet(stations, width = '700px') %>% 
  ...
  fitBounds(lng1=-64.9, lat=17.85, lng2=-64.3, lat2=17.6)%>%
...
```{r fundingsources, include=FALSE, fig.align='left', out.width='100%'}
...
F3 <- ggdraw() + draw_image("Logos/NPS.png", scale = 0.8)
F4 <- ggdraw() + draw_image("Logos/CSA.png", scale = 0.8)
...
```{r funding, echo=FALSE, fig.align='left', out.width='70%'}
funding
```

### Our Team

```{r team, echo=FALSE, out.width = '50%', fig.align='center', caption="St. Croix, USVI 2022 Field team" }
